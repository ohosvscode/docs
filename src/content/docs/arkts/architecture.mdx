...
<CardGrid>
  <LinkCard title="@arkts/debugger" href="https://github.com/ohosvscode/debugger" description="ArkTS 鸿蒙项目调试器。该npm包通过研究 DevEco Studio 本体而诞生，感谢 github@sanchuanhehe的逆向成果。" />
  <LinkCard title="@arkts/image-manager" href="https://github.com/ohosvscode/image-manager" description="模拟器镜像管理器, 用于管理模拟器镜像的下载、安装、删除等操作。该npm通过研究 DevEco Studio 本体而诞生。" />
  ...
  <LinkCard title="@arkts/sdk-downloader" href="https://github.com/ohosvscode/sdk-downloader" description="OpenHarmony SDK 下载器，用于流式下载 OpenHarmony SDK, 并提供 github action 直接可用于你的 GitHub Action 的 CI/CD 流水线中。" />
</CardGrid>
